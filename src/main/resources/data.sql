...
(109, '립케어', 3, 3, NOW(), NOW(), FALSE, 35),
(110, '파우더/팩트', 3, 4, NOW(), NOW(), FALSE, 35),
(111, '컨실러', 3, 5, NOW(), NOW(), FALSE, 35),
(112, '프라이머/베이스', 3, 6, NOW(), NOW(), FALSE, 35),
(113, '쉐이딩', 3, 7, NOW(), NOW(), FALSE, 35),
(114, '하이라이터', 3, 8, NOW(), NOW(), FALSE, 35),
(115, '메이크업 픽서', 3, 9, NOW(), NOW(), FALSE, 35),
(116, 'BB/CC', 3, 10, NOW(), NOW(), FALSE, 35),
(117, '아이라이너', 3, 7, NOW(), NOW(), FALSE, 36),
(118, '마스카라', 3, 8, NOW(), NOW(), FALSE, 36),
(119, '아이브로우', 3, 9, NOW(), NOW(), FALSE, 36),
(120, '아이섀도우', 3, 10, NOW(), NOW(), FALSE, 36),
(121, '아이래쉬 케어', 3, 3, NOW(), NOW(), FALSE, 36),
(122, '아이 픽서', 3, 0, NOW(), NOW(), FALSE, 36);

-- depth:3 헤어케어 하위의 하위
INSERT INTO categories (id, name, depth, display_order, created_at, updated_at, is_deleted, parent_id) VALUES
(123, '샴푸', 3, 0, NOW(), NOW(), FALSE, 42),
(124, '린스/컨디셔너', 3, 1, NOW(), NOW(), FALSE, 42),
(125, '드라이샴푸', 3, 2, NOW(), NOW(), FALSE, 42),
(126, '스케일러', 3, 3, NOW(), NOW(), FALSE, 42),
(127, '헤어 트리트먼트', 3, 0, NOW(), NOW(), FALSE, 43),
(128, '노워시 트리트먼트', 3, 1, NOW(), NOW(), FALSE, 43),
(129, '헤어토닉/두피토닉', 3, 0, NOW(), NOW(), FALSE, 44),
(130, '헤어세럼', 3, 0, NOW(), NOW(), FALSE, 45),
(131, '헤어오일', 3, 1, NOW(), NOW(), FALSE, 45),
(132, '컬러염색/탈색', 3, 0, NOW(), NOW(), FALSE, 46),
(133, '새치염색', 3, 1, NOW(), NOW(), FALSE, 46),
(134, '헤어메이크업', 3, 2, NOW(), NOW(), FALSE, 46),
(135, '파마', 3, 3, NOW(), NOW(), FALSE, 46),
(136, '컬크림/컬링에센스', 3, 0, NOW(), NOW(), FALSE, 48),
(137, '왁스/젤/무스/토닉', 3, 1, NOW(), NOW(), FALSE, 48),
(138, '스프레이/픽서', 3, 2, NOW(), NOW(), FALSE, 48);

-- depth:3 바디케어 하위의 하위
INSERT INTO categories (id, name, depth, display_order, created_at, updated_at, is_deleted, parent_id) VALUES
(139, '바디로션', 3, 0, NOW(), NOW(), FALSE, 49),
(140, '바디크림', 3, 1, NOW(), NOW(), FALSE, 49),
(141, '바디미스트', 3, 0, NOW(), NOW(), FALSE, 50),
(142, '바디오일', 3, 1, NOW(), NOW(), FALSE, 50),
(143, '핸드크림', 3, 0, NOW(), NOW(), FALSE, 51),
(144, '핸드워시', 3, 1, NOW(), NOW(), FALSE, 51),
(145, '풋크림', 3, 0, NOW(), NOW(), FALSE, 52),
(146, '풋샴푸', 3, 1, NOW(), NOW(), FALSE, 52),
(147, '발냄새제거제', 3, 2, NOW(), NOW(), FALSE, 52),
(148, '바디워시', 3, 0, NOW(), NOW(), FALSE, 53),
(149, '바디스크럽', 3, 1, NOW(), NOW(), FALSE, 53),
(150, '입욕제', 3, 2, NOW(), NOW(), FALSE, 53),
(151, '비누', 3, 3, NOW(), NOW(), FALSE, 53),
(152, '제모크림', 3, 0, NOW(), NOW(), FALSE, 54),
(153, '스트립/왁스', 3, 1, NOW(), NOW(), FALSE, 54),
(154, '데오스틱', 3, 0, NOW(), NOW(), FALSE, 55),
(155, '데오롤온', 3, 1, NOW(), NOW(), FALSE, 55),
(156, '데오스프레이', 3, 2, NOW(), NOW(), FALSE, 55),
(157, '쿨링/데오시트', 3, 3, NOW(), NOW(), FALSE, 55),
(158, '보습', 3, 0, NOW(), NOW(), FALSE, 56),
(159, '세정', 3, 1, NOW(), NOW(), FALSE, 56),
(160, '선케어', 3, 2, NOW(), NOW(), FALSE, 56);

-- depth:3 향수/디퓨저 하위의 하위
INSERT INTO categories (id, name, depth, display_order, created_at, updated_at, is_deleted, parent_id) VALUES
(161, '여성향수', 3, 0, NOW(), NOW(), FALSE, 57),
(162, '남성향수', 3, 1, NOW(), NOW(), FALSE, 57),
(163, '유니섹스향수', 3, 2, NOW(), NOW(), FALSE, 57),
(164, '헤어퍼퓸', 3, 3, NOW(), NOW(), FALSE, 57),
(165, '고체향수', 3, 0, NOW(), NOW(), FALSE, 58),
(166, '소용량향수', 3, 1, NOW(), NOW(), FALSE, 58),
(167, '디스커버리세트', 3, 2, NOW(), NOW(), FALSE, 58),
(168, '디퓨저/캔들/인센스', 3, 0, NOW(), NOW(), FALSE, 59),
(169, '룸스프레이/탈취제', 3, 1, NOW(), NOW(), FALSE, 59),
(170, '차량용방향제/샤셰', 3, 2, NOW(), NOW(), FALSE, 59);
