...
//    private DeliveryPolicy deliveryPolicy; // 배송비 정책
    ...
    public CartProductListDTO(Long id, Long productOptionId, String brandName, String productName, String optionName, int sellingPrice, int quantity, String imageUrl, int currentStock) {
        this.id=id;
